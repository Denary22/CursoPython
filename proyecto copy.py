...
#Display
display2 = Entry(ventana, font= ("Futura", 14), bg=color_display, fg="gray", relief="flat" )
display2.grid(row=1,columnspan=8,sticky=NSEW)
display2.config(justify=RIGHT)
display = Entry(ventana, font= ("Futura", 26, "bold"), bg=color_display, fg=color_letras1, relief="flat")
...
btn_cuadrado = Button(ventana,text="x²", font= ("Futura", 16), bg=color_fondo, fg=color_letras2, relief="flat", command=lambda:get_operation("**2"))
btn_cuadrado.grid(row=3, column=0, sticky=NSEW)
btn_raiz = Button(ventana,text="√", font= ("Futura", 16), bg=color_fondo, fg=color_letras2, relief="flat", command=lambda:get_operation("sqrt("))
btn_raiz.grid(row=3, column=1, sticky=NSEW)
btn_modulo = Button(ventana,text="mod", font= ("Futura", 16), bg=color_fondo, fg=color_letras2, relief="flat", command=lambda:get_operation("%"))
btn_modulo.grid(row=4, column=0, sticky=NSEW)
btn_exp = Button(ventana,text="exp", font= ("Futura", 16), bg=color_fondo, fg=color_letras2, relief="flat", command=lambda:get_operation("**"))
btn_exp.grid(row=4, column=1, sticky=NSEW)
btn_sen = Button(ventana,text="sen", font= ("Futura", 16), bg=color_fondo, fg=color_letras2, relief="flat", command=lambda:get_operation("sin("))
btn_sen.grid(row=5, column=0, sticky=NSEW)
btn_cos = Button(ventana,text="cos", font= ("Futura", 16), bg=color_fondo, fg=color_letras2, relief="flat", command=lambda:get_operation("cos("))
btn_cos.grid(row=5, column=1, sticky=NSEW)
btn_tan = Button(ventana,text="tan", font= ("Futura", 16), bg=color_fondo, fg=color_letras2, relief="flat", command=lambda:get_operation("tan("))
btn_tan.grid(row=6, column=0, sticky=NSEW)
btn_log = Button(ventana,text="ln", font= ("Futura", 16), bg=color_fondo, fg=color_letras2, relief="flat", command=lambda:get_operation("log("))
